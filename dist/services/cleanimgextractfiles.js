...
exports.cleanUpImageFiles = void 0;
var fs_1 = __importDefault(require("fs"));
var path_1 = __importDefault(require("path"));
var logger_1 = __importDefault(require("../logger/logger"));
function cleanUpImageFiles(directory) {
    try {
        fs_1.default.readdir(directory, function (err, files) {
            ...
            logger_1.default.info("deleting image-extract folder content " + files);
            ...
            logger_1.default.info("image-extract files deleted");
        });
    }
    catch (error) {
