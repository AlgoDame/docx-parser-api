...
var GooglePdfConverter = /** @class */ (function () {
    ...
    GooglePdfConverter.prototype.convert = function (pdfOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, inputPath, outputPath, parentFolder, fileId, hasGenerated, error_1;
    ...
    GooglePdfConverter.prototype.uploadFileToDrive = function (auth, inputPath, parentFolder) {
        return new Promise(function (resolve, reject) {
            var driveService = googleapis_1.google.drive({
                version: "v3",
                auth: auth
            });
            var fileMetaData = {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            //log.info("done converting file to pdf")
                                            convertStatus = true;
                                            //log.info("pdf file generated from drive")
                                            console.log("pdf file generated from drive");
                                            return [4 /*yield*/, GooglePdfConverter.deleteFromDrive(auth, fileId)];
                                        case 1:
                                            _a.sent();
    ...
    GooglePdfConverter.deleteFromDrive = function (auth, fileId) {
        return new Promise(function (resolve, reject) {
            return __awaiter(this, void 0, void 0, function () {
                var deleteStatus, driveService, removedFile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            deleteStatus = false;
                        ...
                        case 1:
                            removedFile = _a.sent();
                            if ((removedFile === null || removedFile === void 0 ? void 0 : removedFile.status) === 204) {
                                deleteStatus = true;
                                //log.info("file deleted from drive")
